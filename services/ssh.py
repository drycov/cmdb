...
class SSHSession:
    ...
    def exec(self, command: str) -> Optional[str]:
...
class SSHService:
    ...
    def open_session(self, ip: str, credentials: Credentials) -> Optional[SSHSession]:
        try:
            self.logger.debug(
    ...
    def exec(self, ip: str, credentials: Credentials, command: str) -> Optional[str]:
    ...
    def upload_file_sftp(
        ...
        with session:
            return session.upload_file_sftp(local_path, remote_name)
    ...
    def remote_file_exists(self, ip: str, credentials: Credentials, filename: str) -> bool:
        ...
        with session:
            return session.remote_file_exists(filename)