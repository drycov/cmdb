...
class GoogleConfig:
    ...
    def from_env(cls) -> "GoogleConfig":
        return cls(
            ...
            spreadsheet=os.getenv("GOOGLE_SPREADSHEET", "").strip(),
            worksheet=os.getenv("GOOGLE_WORKSHEET", "Inventory").strip(),
        )
...
class AppConfig:
    ...
    def from_env(cls) -> "AppConfig":
        ...
        return cls(
            ...
            log_console_level=os.getenv(
                "LOG_CONSOLE_LEVEL",
                os.getenv("LOG_LEVEL", "INFO"),
            ).upper().strip(),
            log_file_level=os.getenv(
                "LOG_FILE_LEVEL",
                os.getenv("LOG_LEVEL", "INFO"),
            ).upper().strip(),
            ...
            log_max_bytes_mb=int(os.getenv("LOG_MAX_BYTES_MB", "10")),
            log_backup_count=int(os.getenv("LOG_BACKUP_COUNT", "5")),
            log_inventory_details=_get_bool("LOG_INVENTORY_DETAILS", False),
